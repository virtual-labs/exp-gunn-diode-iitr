        ...
        actual_connections.forEach(function (connection) {
            ...
            if(!is_connected_1_4){
                is_connected_1_4 = correct_connections_1_4.find(function (conn) {
                    //console.log(this_connection.source);
            ...
            return;
                ...
                Swal.fire({
                   ...
                   width:'450px',
                    ...
                    html:'<div style="text-align:left;color:blue">Please connect: </div><table>  <tr> <td style="color:red">1. Pin Supply &harr; F</td></tr><tr> <td style="color:red">2. Gunn Supply &harr; A</td></tr><tr> <td style="color:red">3. B &harr; E</td></tr></table>',
                    icon:'warning',
                    });
